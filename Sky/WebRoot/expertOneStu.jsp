								...
								<s:iterator value="list">
									<tr class="gradec">
										...
										<td style="text-align: center;" ><a class="btn-sm" 
											href="expertDetailVisionInfo.action?tableId=<s:property value='tableId'/>">查看详情</a>
										</td>
									</tr>
								</s:iterator>
							</tbody>
						...
						<table>
							<tr>
								<td><s:if test="%{pageBean.currentPage == 1}">首页      上一页</s:if>
									<s:else>
										<a href="expertDiagnoseOneStu!expertDiagnoseOneStu?username=${username}&page=1">首页</a>
										<a
											href="expertDiagnoseOneStu!expertDiagnoseOneStu?username=${username}&page=<s:property value="%{pageBean.currentPage-1}"/>" />上一页</a>
									</s:else></td>
								<td><s:if
										test="%{pageBean.currentPage != pageBean.totalPage}">
										<a
											href="expertDiagnoseOneStu!expertDiagnoseOneStu?username=${username}&page=<s:property value="%{pageBean.currentPage+1}"/>">下一页</a>
										<a
											href="expertDiagnoseOneStu!expertDiagnoseOneStu?username=${username}&page=<s:property value="pageBean.totalPage"/>">尾页</a>
