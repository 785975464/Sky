				...
				<div class="menu-and-banner">
					<div class="menu-part">
						<ul>
							...
							<li><a href="findMoreSheets?page=1">问卷调查</a></li>
					...
					<div class="banner">
						<div class="newscenterdiv">
							...
							<div id="pageTable">
								...
								<s:else>
									<a href="findMoreNews!findMoreNews?page=1">首页 </a>
									<a href="findMoreNews!findMoreNews?page=<s:property value="%{pageBean.currentPage-1}"/>" />上一页 </a>
								</s:else>
								<s:if test="%{pageBean.currentPage != pageBean.totalPage}">
									<a href="findMoreNews!findMoreNews?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页 </a>
									<a href="findMoreNews!findMoreNews?page=<s:property value="pageBean.totalPage"/>">尾页 </a>
								</s:if>
