					...
					<div class="banner">
						<div class="newscenterdiv">
							<div class="newstbodydiv">
								<table>
									<s:iterator value="list">
										<tr>
											<td>
												<a href="userSheetsByID?sheetid=<s:property value='sheetid'/>"><s:property value="sheetname"/></a>
											</td>
										</tr>
									</s:iterator>
								</table>
							...
							<div id="pageTable">
								...
								<s:else>
									<a href="userSheets!userSheets?page=1">首页 </a>
									<a href="userSheets!userSheets?page=<s:property value="%{pageBean.currentPage-1}"/>" />上一页 </a>
								</s:else>
								<s:if test="%{pageBean.currentPage != pageBean.totalPage}">
									<a href="userSheets!userSheets?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页 </a>
									<a href="userSheets!userSheets?page=<s:property value="pageBean.totalPage"/>">尾页 </a>
								</s:if>
