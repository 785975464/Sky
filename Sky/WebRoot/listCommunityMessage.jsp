				...
				<div class="context">
					...
					<div>
						<div id="pageTable">
								...
								<s:else>
									<a href="listCommunityMessage!listCommunityMessage?page=1">首页 </a>
									<a href="listCommunityMessage!listCommunityMessage?page=<s:property value="%{pageBean.currentPage-1}"/>" />上一页 </a>
								</s:else>
								<s:if test="%{pageBean.currentPage != pageBean.totalPage}">
									<a href="listCommunityMessage!listCommunityMessage?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页 </a>
									<a href="listCommunityMessage!listCommunityMessage?page=<s:property value="pageBean.totalPage"/>">尾页 </a>
								</s:if>
