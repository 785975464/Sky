					...
					<div>
						<div id="pageTable">
							<!-- 
								...
								<s:else>
									<a href="listMessage!listMessage?page=1">首页 </a>
									<a href="listMessage!listMessage?page=<s:property value="%{pageBean.currentPage-1}"/>" />上一页 </a>
								</s:else>
								<s:if test="%{pageBean.currentPage != pageBean.totalPage}">
									<a href="listMessage!listMessage?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页 </a>
									<a href="listMessage!listMessage?page=<s:property value="pageBean.totalPage"/>">尾页 </a>
								</s:if>
