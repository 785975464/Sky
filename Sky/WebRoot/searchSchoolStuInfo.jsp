	...
	<div class="content sky-content" id="page-container">
		<div class="frame-records">
			<div class="records-new part4">
				<div class="title" id="school-manage">学生管理 <!-- 搜索结果 -->
						...
						<table id="pageTable">
							<tr>
								<td><s:if test="%{pageBean.currentPage == 1}">首页      上一页</s:if>
									<s:else>
										<a href="searchStuInfo!searchStuInfo?page=1">首页</a>
										<a
											href="searchStuInfo!searchStuInfo?page=<s:property value="%{pageBean.currentPage-1}"/>" />上一页</a>
									</s:else></td>
								<td><s:if
										test="%{pageBean.currentPage != pageBean.totalPage}">
										<a
											href="searchStuInfo!searchStuInfo?page=<s:property value="%{pageBean.currentPage+1}"/>">下一页</a>
										<a
											href="searchStuInfo!searchStuInfo?page=<s:property value="pageBean.totalPage"/>">尾页</a>
